...
void BCMenuData::SetWideString(const wchar_t *szWideString)
{
	...
	if (szWideString)
    {
		...
		if (m_szMenuText)
			//wcscpy(m_szMenuText,szWideString);  //qswgai02
			wcscpy_s(m_szMenuText,sizeof(szWideString),szWideString);//qswgai02
    }
	else
...
BOOL BCMenu::LoadMenu(LPCTSTR lpszResourceName)
{
	...
	do{
		...
		wcscpy_s(szCaption,sizeof(szCaption),(wchar_t *)pTp);
