...
CXPButton::CXPButton()
{
	...
	m_pFont = new CFont;
	m_pFont->CreateFont(20,0,0,0,FW_BOLD,FALSE,FALSE,FALSE,DEFAULT_CHARSET,OUT_RASTER_PRECIS,CLIP_DEFAULT_PRECIS,VARIABLE_PITCH|PROOF_QUALITY,FF_DONTCARE,_T("Arial"));
}
	...
	if (strText.GetLength())
	{
		...
		//{
			...
			if (state & ODS_SELECTED)
				dcMem.SetTextColor(RGB(255,0,0));
			dcMem.SetBkMode(TRANSPARENT);
			dcMem.DrawText(strText,&rect,DT_CENTER|DT_VCENTER);
		//}
