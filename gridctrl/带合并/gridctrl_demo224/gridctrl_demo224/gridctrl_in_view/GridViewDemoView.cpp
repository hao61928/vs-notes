...
BEGIN_MESSAGE_MAP(CGridViewDemoView, CView)
	...
	ON_COMMAND(ID_EDIT_MERGECELLS, OnEditMergecells)
END_MESSAGE_MAP()
...
void CGridViewDemoView::OnInitialUpdate() 
{
	...
	if (m_pGridCtrl == NULL)
	{
		...
		try {
			...
			m_pGridCtrl->SetFixedRowCount(3);
	   ...
	   m_pGridCtrl->MergeCells(0,2,0,4);
	   m_pGridCtrl->MergeCells(1,2,2,3);
...
void CGridViewDemoView::OnEditMergecells()
{
