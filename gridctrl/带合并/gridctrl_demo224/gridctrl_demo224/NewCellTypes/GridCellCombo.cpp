...
{
	CCheckComboBox::PostNcDestroy();

	delete this;
}

BEGIN_MESSAGE_MAP(CInPlaceList, CCheckComboBox)
...
{
	CCheckComboBox::OnKillFocus(pNewWnd);
...
void CInPlaceList::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	...
	CCheckComboBox::OnKeyUp(nChar, nRepCnt, nFlags);
}
